...
image_drop= Image.open("Images/zoomin4columns.png")
image_ratio_bed= Image.open("Images/ratio_bed_excel.png")
image_ratio_bed2=Image.open("Images/square_feet_and_beds.png")
image_opp_1=Image.open("Images/additionalopppt1.png")
image_opp_2=Image.open("Images/additionalopppt2.png")
image_lot_1=Image.open("Images/ratio_lotpt1.png")
image_lot_2=Image.open("Images/ratio_lotpt2.png")
image_pot_1= Image.open("Images/adu_pot1.png")
image_pot_2=Image.open("Images/adu_pot2.png")
image_final=Image.open("Images/outputfinal.png")
